...
<div class="cards">
   ...
   <div class="card">
     ...
     <input id=demoInput type="number" class="form-control" value="1" min="1">
     <div class="card-text">R3500.00</div>
     <button type="button" class="btn btn-secondary ms-3" onclick="addToCart(0)">Cart</button>
